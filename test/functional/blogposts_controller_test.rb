...
class BlogpostsControllerTest < ActionController::TestCase
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post :create, blogpost: { issue_text: @blogpost.issue_text, issue_title: @blogpost.issue_title }
    end
  ...
  test "should update blogpost" do
    put :update, id: @blogpost, blogpost: { issue_text: @blogpost.issue_text, issue_title: @blogpost.issue_title }
    assert_redirected_to blogpost_path(assigns(:blogpost))
  end
